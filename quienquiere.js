...
(lib.quienquiere = function(mode,startPosition,loop) {
	...
	this.shape_33.graphics.f().s("#00FF00").ss(6,1,1).p("A2ZiFIKnAAA1nhdIVjSjAroxFITgAAAICwxIgKNcArojBIAKt6AWaiZI2WTLAI0iZINcgU");
	this.shape_33.setTransform(189.5,268.5);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FFFFFF").s().p("AAnBHIgTgeIgOgTQgFgIgCgCQgFgDgEgBIgLgBIgWAAIAABAIgTAAIAAiNIA+AAQATAAAKAEQAKADAGAKQAGAKAAAMQAAAPgKAKQgKAJgUADQAHAEAEADQAIAIAIALIAZAngAgrgHIApAAQALAAAHgCQAIgDAEgGQADgGAAgHQAAgKgHgHQgHgGgQAAIgsAAg");
	this.shape_34.setTransform(204.3,330.4);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFFFF").s().p("AAtBHIgQgsIg6AAIgQAsIgUAAIA3iNIASAAIA7CNgAgJgcIgPAoIAvAAIgQgmIgIgdQgCANgGAOg");
	this.shape_35.setTransform(189.8,330.4);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFFFF").s().p("AggBAQgPgJgHgTQgIgRAAgTQAAgWAJgQQAIgSAQgIQAQgIARAAQAVgBAPALQAPAMAFATIgSAFQgFgQgKgIQgJgGgPAAQgOAAgLAIQgLAHgFAOQgEANAAAOQAAARAFANQAFAOAMAHQALAGALAAQAQAAALgJQALgJAEgSIATAFQgGAXgQAMQgPAMgXAAQgVAAgOgJg");
	this.shape_36.setTransform(170.4,330.4);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFFFFF").s().p("AAlBHIhKhuIAABuIgSAAIAAiNIATAAIBKBuIAAhuIASAAIAACNg");
	this.shape_37.setTransform(150.3,330.4);

	this.reinicioo = new lib.reinicio_1();
	this.reinicioo.setTransform(186.7,330.1,0.423,0.856);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.respdd}]},39).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"Conmutativa",lineWidth:269}}]},20).to({state:[]},1).to({state:[{t:this.respdd}]},22).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"A∩B",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"entonces",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"⌐ p ʌ q",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"Ser enteros",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},22).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"El cuadrado del divisor",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},22).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"(A∆B)∩B",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"entonces",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"p → q",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"CON",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},22).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"A∩B",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},22).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"A∩B",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"entonces",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"p → q",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},19).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"CON",lineWidth:267}}]},18).to({state:[]},1).to({state:[{t:this.respdd}]},22).to({state:[{t:this.respdd},{t:this.preg1d,p:{text:"A∩B",lineWidth:267}}]},18).to({state:[]},1).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.respaa}]},39).to({state:[{t:this.respaa}]},10).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"Afirmativa"}}]},10).to({state:[]},1).to({state:[{t:this.respaa}]},22).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"AUB"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"si y solo si"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"p v q"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"Un divisor común"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},22).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"Multiplo del divisor"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},22).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"(AUB)∩A"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"si y solo si"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"p v q"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"ACA"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},22).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"AUB"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},22).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"AUB"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"si y solo si"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"p v q"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},19).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"ACA"}}]},11).to({state:[]},1).to({state:[{t:this.respaa}]},22).to({state:[{t:this.respaa}]},7).to({state:[{t:this.respaa},{t:this.preg1a,p:{text:"AUB"}}]},11).to({state:[]},1).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},39).to({state:[{t:this.instance_8}]},7).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:17,y:66,text:"Una de las caracteristicas de las proposiciones simples es:",lineWidth:343}}]},13).to({state:[]},1).to({state:[{t:this.instance_7}]},22).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Los elementos que pertenecen al conjunto A y no pertece a B se representan con :",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"CONJUNCION hace referencia al conector logico:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"La frase \"si, gasto las onces hoy, usted gasta mañana\" se puede representar como:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Para simplificar un numero racional, el numerador y el denominador deben tener:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},22).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"La division de Enteros necesita que el numerador sea:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},22).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"La diferencia simetria entre dos conjuntos A y B esta definida con la operación",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"CONJUNCION hace referencia al conector logico:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"La frase \"si, gasto las onces hoy, usted gasta mañana\" se puede representar como:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Gabriel 1",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},22).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Los elementos que pertenecen al conjunto A y no pertece a B se representan con :",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},22).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Los elementos que pertenecen al conjunto A y no pertece a B se representan con :",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"CONJUNCION hace referencia al conector logico:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"La frase \"si, gasto las onces hoy, usted gasta mañana\" se puede representar como:",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},19).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Gabriel 1",lineWidth:326}}]},14).to({state:[]},1).to({state:[{t:this.instance_7}]},22).to({state:[{t:this.instance_8}]},4).to({state:[{t:this.instance_8},{t:this.pregunt1,p:{x:26.3,y:80.5,text:"Los elementos que pertenecen al conjunto A y no pertece a B se representan con :",lineWidth:326}}]},14).to({state:[]},1).wait(43));
